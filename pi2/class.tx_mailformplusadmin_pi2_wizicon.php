 ...
 */
class tx_mailformplusadmin_pi2_wizicon {
	...
	public function proc(array $wizardItems) {
		...
		$wizardItems['plugins_tx_mailformplusadmin_pi2'] = array(
	...
	protected function includeLocalLang() {
		$llFile = t3lib_extMgm::extPath('mailformplus_admin') . 'locallang.xml';
...
if (defined('TYPO3_MODE') && isset($GLOBALS['TYPO3_CONF_VARS'][TYPO3_MODE]['XCLASS']['ext/mailformplus_admin/pi2/class.tx_mailformplusadmin_pi2_wizicon.php'])) {
	include_once($GLOBALS['TYPO3_CONF_VARS'][TYPO3_MODE]['XCLASS']['ext/mailformplus_admin/pi2/class.tx_mailformplusadmin_pi2_wizicon.php']);
}
